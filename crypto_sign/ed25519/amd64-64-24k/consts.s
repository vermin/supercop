#ifdef __APPLE__
  #define WAZN_LOCAL_SYMBOL(x) .private_extern x
#else
  #define WAZN_LOCAL_SYMBOL(x) .hidden x
#endif
...
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
WAZN_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
